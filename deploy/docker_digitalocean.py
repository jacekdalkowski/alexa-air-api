...
if __name__ == '__main__':
	...
	copy_api_src_to_remote_host(ssh_con_str, env_config['deploy_dir'])
	build_api_continer_in_remote_host(ssh, env_config['image_tag'], env_config['deploy_dir'])
	run_api_container(ssh, env_config['image_tag'], env_config['db_container_name'], env_config['container_name'])
